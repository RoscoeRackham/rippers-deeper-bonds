...
// Checks: TWO-ASSET RULE (assets named exactly module.json + rippers-deeper-bonds.zip — a missing/mis-named
...
const REPO = 'RoscoeRackham/rippers-deeper-bonds';
const ID = 'rippers-deeper-bonds';
